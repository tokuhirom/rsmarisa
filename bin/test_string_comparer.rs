...
fn main() {
    ...
    println!("a vs banana:");
    println!("  compare(a, banana) = {}", StringComparer::compare(&a, &banana));
    println!("  compare(banana, a) = {}", StringComparer::compare(&banana, &a));
    ...
    println!("\napp vs apply:");
    println!("  compare(app, apply) = {}", StringComparer::compare(&app, &apply));
    println!("  compare(apply, app) = {}", StringComparer::compare(&apply, &app));
